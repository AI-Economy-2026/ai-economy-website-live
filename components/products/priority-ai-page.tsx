...
export function PriorityAIPage({ product }: PriorityAIPageProps) {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero */}
      <section className="relative pt-24 min-h-[85vh] flex items-center overflow-hidden bg-black">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 w-full">
          <div className="max-w-3xl">
            ...
            <p className="text-white/70 text-xl md:text-2xl font-medium max-w-2xl leading-relaxed mb-12">
              In less than 10 minutes, find out where AI can automate operations, cut costs, and
              help you scale. Get a tailored roadmap with confident next steps.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                icon: Target,
                text: 'AI pilots scattered across departments with no strategic thread',
              },
              {
                icon: Banknote,
                text: "Budget spent on tools nobody uses because teams weren't ready",
              },
              {
                icon: ShieldX,
                text: 'Resistance from teams who see AI as a threat, not an advantage',
              },
            ].map((point) => {
              ...
              return (
                ...
                >
                  <div className="mb-6 w-14 h-14 rounded-2xl bg-softGrey flex items-center justify-center">
                    <Icon className="w-7 h-7 text-ink/60" />
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-20">
            ...
            <p className="text-xl text-ink/60 font-medium">
              Run one or run all three. Each builds on the last.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={mod.id}
                className="flex flex-col h-full bg-softGrey/30 rounded-[40px] p-10 border border-ink/5"
              >
                <div className="flex justify-between items-start mb-8">
                  <span className="text-6xl font-black text-black/10 tabular-nums leading-none tracking-tighter">
                    {mod.id}
                  </span>
                ...
                <p className="text-ink/60 font-medium leading-relaxed mb-10">{mod.desc}</p>
                <div className="mt-auto space-y-4 pt-8 border-t border-ink/5">
                  {mod.features.map((f) => (
                    <div key={f} className="flex items-center space-x-3">
                      <CheckCircle2 className="w-5 h-5 text-brandBlue" />
                      <span className="font-medium text-sm text-ink/80">{f}</span>
                    </div>
                  ))}
                </div>
              </div>
      ...
      <section className="py-32 bg-black text-white overflow-hidden relative">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="mb-20 max-w-3xl">
            ...
            <p className="text-xl text-white/60 font-medium">
              Every department plotted across two axes. AI opportunity vs. team readiness.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-white/10 rounded-[40px] overflow-hidden p-[1px]">
            {[
              {
                title: 'Fast Track',
                cond: 'High opportunity + High readiness',
                act: 'Deploy now',
                bg: 'bg-white/5',
              ...
              {
                title: 'Train First',
                cond: 'High opportunity + Low readiness',
                act: 'Upskill before tools',
                bg: 'bg-black/50',
                hover: 'hover:bg-white/5',
              },
              {
                title: 'Optimise',
                cond: 'Low opportunity + High readiness',
                act: 'Revisit later',
                bg: 'bg-black/80',
              ...
              {
                title: 'Foundation',
                cond: 'Low opportunity + Low readiness',
                act: 'Build fundamentals first',
                bg: 'bg-black',
              ...
              <div
                key={i}
                className={`${quad.bg} ${quad.hover} p-12 md:p-16 transition-colors duration-500 flex flex-col justify-center h-[300px]`}
              >
                <h3 className="text-3xl font-bold mb-4">{quad.title}</h3>
                <p className="text-white/40 text-sm font-semibold uppercase tracking-widest mb-8">
                  {quad.cond}
                </p>
                <div className="flex items-center space-x-2 text-brandBlue font-bold mt-auto">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-brandBlue/20 blur-[150px] pointer-events-none" />
      </section>
            ...
            {[
              {
                ...
                desc: 'Answer questions about your operations, team capabilities, and culture. Takes 15 to 20 minutes per module.',
              },
              {
                step: '02',
                title: 'Receive your Priority Matrix',
                desc: 'Every department plotted on a 2×2 grid showing exactly where to start, where to train, and where to wait.',
              },
              {
                step: '03',
                title: 'Get your action plan',
                desc: 'A prioritised roadmap with specific recommendations for tools, training, and quick wins. Ready to present to leadership.',
              },
            ].map((s, i) => (
              <div
                key={s.step}
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-ink/60 font-medium text-lg leading-relaxed">{s.desc}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <p className="text-[11px] font-bold text-ink/30 uppercase tracking-[0.2em] mb-8">
            Built for.
          </p>
          <div className="flex flex-wrap justify-center gap-3 mb-24">
            {[
              ...
              <span
                key={role}
                className="px-6 py-3 bg-softGrey/50 rounded-full font-semibold text-ink/80 text-sm"
              >
                {role}
              </span>
            ))}
