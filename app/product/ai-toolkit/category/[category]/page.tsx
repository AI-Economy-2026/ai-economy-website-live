...
export default function AIToolkitCategoryPage({
  params,
}: {
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          {categoryTools.length > 0 ? (
            ...
            <div className="text-center py-16">
              <p className="text-foreground/50 font-medium text-lg mb-6">No tools in this category yet &mdash; check back soon.</p>
              <Link href="/product/ai-toolkit/tools" className="px-6 py-3 bg-black text-white rounded-full font-semibold text-sm hover:bg-[#111] transition-colors">
                Browse all tools
              </Link>
            </div>
          )}
